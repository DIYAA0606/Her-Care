...
function MySymptoms() {
  ...
  <div>
    <p style={{ fontSize: 12, color: "#A07890", margin: "0 0 4px", letterSpacing: "0.04em" }}>Your history</p>
    <h1 style={{ fontSize: 22, fontWeight: 700, color: "#2D1F2A", margin: 0 }}>My symptoms</h1>
  </div>
  <button
